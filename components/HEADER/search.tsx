  ...
  return (
    <div
      ...
      relative flex items-center transition-all duration-300 ease-in-out
       w-full max-w-sm mx-auto mt-2 
        md:w-10 md:focus-within:w-[60vw] lg:focus-within:w-[40vw]
       xl:w-[32rem] xl:max-w-full ${className}
       w-full max-w-sm mx-auto mt-2
       md:w-10 md:focus-within:w-[60vw] lg:focus-within:w-[40vw]
    ...
    >
      <input
        ...
        className={`
          ...
          h-10
           w-full border border-gray-300 rounded pl-4 pr-10 py-1 
